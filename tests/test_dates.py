...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("15.01", "2027-01-15"),
        # месяц словами — просьба заказчика «говорить не 07 месяц, а июля»
        ("23 июля в 8:00", "2026-07-23T08:00:00+10:00"),
        ("23 июля в 8 утра", "2026-07-23T08:00:00+10:00"),
        ("23 июля 2026 10:30", "2026-07-23T10:30:00+10:00"),
        ("1 августа", "2026-08-01"),
        ("5 января", "2027-01-05"),
        ("25 июль", "2026-07-25"),
        # прошедший в этом году день с месяцем словами — на следующий год
        ("15 июля", "2027-07-15"),
        ("напомни 25 декабря купить подарки", "2026-12-25"),
